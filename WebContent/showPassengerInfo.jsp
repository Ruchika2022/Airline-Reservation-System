        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <form action="ActionServlet" method="post">
                 <%ArrayList<PassengerBean> list = (ArrayList<PassengerBean>)request.getAttribute("passengerDetails"); %>
                
                <h2>Passenger details for flight number : <%=request.getAttribute("flightNum") %></h2>
                
                <h4>Departure Airport : <%=request.getAttribute("departAir") %></h4>
                <h4>Arrrival Airport : <%=request.getAttribute("arrAir") %></h4>
                <h4>Scheduled Departure Time : <%=request.getAttribute("departTime") %></h4>
                <h4>Scheduled Arrival Time : <%=request.getAttribute("arrTime") %></h4>
                                
                <table style="width: 95%" border="1">
                <tr>
                <th align="center" >Customer Name
                </th>
                
                <th align="center">Seat Number
                </th>
                
                <th align="center">Customer Phone
                </th>
